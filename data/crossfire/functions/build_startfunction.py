...
file.write("execute if score map map matches 1 run clone 438 77 364 432 81 361 526 70 274\n")
file.write("execute if score map map matches 1 run clone 438 77 369 432 81 366 526 70 315\n")
file.write("\n")
file.write("# Remove the logos\n")
file.write("execute if score map map matches 0 run fill 525 109 403 528 89 440 air\n")
file.write("execute if score map map matches 1 run fill 528 89 315 525 109 278 air\n")
