...
execute as @a[tag=!spectating,tag=!died,tag=!admin,tag=givecrossbow] store result score @s item_cross run clear @s[tag=!admin] minecraft:crossbow 0
execute as @a[tag=!spectating,tag=!died,tag=!admin,tag=givecrossbow] if score @s item_cross matches 0 run replaceitem entity @s container.2 crossbow{HideFlags:63,Charged:0b} 1
...
execute as @a[tag=givecrossbow,scores={timer=1..10}] run replaceitem entity @s container.2 crossbow{CustomModelData:17,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow\",\"color\":\"gray\"}"}} 1
execute as @a[tag=givecrossbow,scores={timer=11..20}] run replaceitem entity @s container.2 crossbow{CustomModelData:18,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow\",\"color\":\"gray\"}"}} 1
execute as @a[tag=givecrossbow,scores={timer=21..30}] run replaceitem entity @s container.2 crossbow{CustomModelData:19,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow\",\"color\":\"gray\"}"}} 1
execute as @a[tag=givecrossbow,scores={timer=31..40}] run replaceitem entity @s container.2 crossbow{CustomModelData:20,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow\",\"color\":\"gray\"}"}} 1
