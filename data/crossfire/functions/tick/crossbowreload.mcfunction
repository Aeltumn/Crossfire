...
execute as @a[tag=mapchanger,tag=!admin] if score @s item_tele matches 2.. run clear @s[tag=!admin] minecraft:carrot_on_a_stick{CustomModelData:2}
execute as @a[tag=mapchanger,tag=!admin] if score @s item_tele matches 2.. run clear @s[tag=!admin] minecraft:carrot_on_a_stick{CustomModelData:3}
...
execute as @a[tag=!spectating,tag=!died,tag=!admin,tag=givecrossbow] store result score @s item_cross run clear @s[tag=!admin] minecraft:crossbow 0
execute as @a[tag=!spectating,tag=!died,tag=!admin,tag=givecrossbow] if score @s item_cross matches 0 run replaceitem entity @s container.1 crossbow{HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Empty Crossbow\",\"color\":\"dark_gray\"}"}} 1
...
execute as @a[tag=givecrossbow,scores={timer=1..10}] run replaceitem entity @s container.1 crossbow{CustomModelData:17,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow\",\"color\":\"dark_gray\"}"}} 1
execute as @a[tag=givecrossbow,scores={timer=11..20}] run replaceitem entity @s container.1 crossbow{CustomModelData:18,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow.\",\"color\":\"dark_gray\"}"}} 1
execute as @a[tag=givecrossbow,scores={timer=21..30}] run replaceitem entity @s container.1 crossbow{CustomModelData:19,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow..\",\"color\":\"dark_gray\"}"}} 1
execute as @a[tag=givecrossbow,scores={timer=31..40}] run replaceitem entity @s container.1 crossbow{CustomModelData:20,HideFlags:63,Charged:0b,display:{Name:"{\"italic\":false,\"text\":\"Reloading Crossbow...\",\"color\":\"dark_gray\"}"}} 1
