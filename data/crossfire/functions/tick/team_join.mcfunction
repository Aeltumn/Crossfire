...
execute as @a at @s if block ~ ~-1 ~ minecraft:lime_concrete if entity @s[team=!green,tag=!admin] run tag @s add joined0
...
execute as @a at @s if block ~ ~-1 ~ minecraft:red_concrete if entity @s[team=!red,tag=!admin] run tag @s add joined0
...
execute as @a at @s if block ~ ~-1 ~ minecraft:yellow_concrete if entity @s[team=!yellow,tag=!admin] run tag @s add joined0
...
execute as @a at @s if block ~ ~-1 ~ minecraft:light_blue_concrete if entity @s[team=!blue,tag=!admin] run tag @s add joined0
...
execute as @a at @s if block ~ ~-1 ~ minecraft:orange_concrete if entity @s[team=!orange,tag=!admin] run tag @s add joined1
...
execute as @a at @s if block ~ ~-1 ~ minecraft:magenta_concrete if entity @s[team=!magenta,tag=!admin] run tag @s add joined1
