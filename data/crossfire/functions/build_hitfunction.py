...
for i in range(1, 12):
    name = "player" + str(i)
    s("execute if entity @s[tag=red,tag="+name+"] if entity @e[distance=..3,type=minecraft:player,team=red,limit=1] run title @a[tag="+name+"] actionbar [\"\",{\"text\":\"Don't attack your teammates!\",\"color\":\"red\"}]")
    s("execute if entity @s[tag=yellow,tag="+name+"] if entity @e[distance=..3,type=minecraft:player,team=yellow,limit=1] run title @a[tag="+name+"] actionbar [\"\",{\"text\":\"Don't attack your teammates!\",\"color\":\"red\"}]")
    s("execute if entity @s[tag=green,tag="+name+"] if entity @e[distance=..3,type=minecraft:player,team=green,limit=1] run title @a[tag="+name+"] actionbar [\"\",{\"text\":\"Don't attack your teammates!\",\"color\":\"red\"}]")
    s("execute if entity @s[tag=blue,tag="+name+"] if entity @e[distance=..3,type=minecraft:player,team=blue,limit=1] run title @a[tag="+name+"] actionbar [\"\",{\"text\":\"Don't attack your teammates!\",\"color\":\"red\"}]")
    s("")
s("")
