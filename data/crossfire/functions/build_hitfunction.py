...
s("# Killscreens")
s("# Red killscreen")
s("execute if entity @s[tag=red] as @e[distance=..3,type=minecraft:player] if entity @s[team=!red,tag=!died,scores={respawnshield=..0}] run title @s subtitle {\"text\":\"\\uE004\"}")
s("execute if entity @s[tag=red] as @e[distance=..3,type=minecraft:player] if entity @s[team=!red,tag=!died,scores={respawnshield=..0}] run title @s title [\"\",{\"text\":\" \\uE006 \"},{\"text\":\"Sploded! \",\"bold\":true,\"color\":\"red\"},{\"text\":\"\\uE006\"}]")
s("execute if entity @s[tag=red] as @e[distance=..3,type=minecraft:player] if entity @s[team=!red,tag=!died,scores={respawnshield=..0}] run tag @s add hit")
s("")
s("# Yellow killscreen")
s("execute if entity @s[tag=yellow] as @e[distance=..3,type=minecraft:player] if entity @s[team=!yellow,tag=!died,scores={respawnshield=..0}] run title @s subtitle {\"text\":\"\\uE004\"}")
s("execute if entity @s[tag=yellow] as @e[distance=..3,type=minecraft:player] if entity @s[team=!yellow,tag=!died,scores={respawnshield=..0}] run title @s title [\"\",{\"text\":\" \\uE007 \"},{\"text\":\"Sploded! \",\"bold\":true,\"color\":\"yellow\"},{\"text\":\"\\uE007\"}]")
s("execute if entity @s[tag=yellow] as @e[distance=..3,type=minecraft:player] if entity @s[team=!yellow,tag=!died,scores={respawnshield=..0}] run tag @s add hit")
s("")
s("# Green killscreen")
s("execute if entity @s[tag=green] as @e[distance=..3,type=minecraft:player] if entity @s[team=!green,tag=!died,scores={respawnshield=..0}] run title @s subtitle {\"text\":\"\\uE004\"}")
s("execute if entity @s[tag=green] as @e[distance=..3,type=minecraft:player] if entity @s[team=!green,tag=!died,scores={respawnshield=..0}] run title @s title [\"\",{\"text\":\" \\uE008 \"},{\"text\":\"Sploded! \",\"bold\":true,\"color\":\"green\"},{\"text\":\"\\uE008\"}]")
s("execute if entity @s[tag=green] as @e[distance=..3,type=minecraft:player] if entity @s[team=!green,tag=!died,scores={respawnshield=..0}] run tag @s add hit")
s("")
s("# Blue killscreen")
s("execute if entity @s[tag=blue] as @e[distance=..3,type=minecraft:player] if entity @s[team=!blue,tag=!died,scores={respawnshield=..0}] run title @s subtitle {\"text\":\"\\uE004\"}")
s("execute if entity @s[tag=blue] as @e[distance=..3,type=minecraft:player] if entity @s[team=!blue,tag=!died,scores={respawnshield=..0}] run title @s title [\"\",{\"text\":\" \\uE005 \"},{\"text\":\"Sploded! \",\"bold\":true,\"color\":\"aqua\"},{\"text\":\"\\uE005\"}]")
