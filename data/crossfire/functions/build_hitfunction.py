...
s("")
s("# Orange killscreen")
s("execute if entity @s[tag=orange] as @a[distance=..3,team=!orange,tag=!died,tag=!admin,scores={respawnshield=..0}] run title @s subtitle {\"text\":\"\\uE004\"}")
s("execute if entity @s[tag=orange] as @a[distance=..3,team=!orange,tag=!died,tag=!admin,scores={respawnshield=..0}] run title @s title [\"\",{\"text\":\" \\uE009 \"},{\"text\":\"Sploded! \",\"bold\":true,\"color\":\"gold\"},{\"text\":\"\\uE009\"}]")
s("execute if entity @s[tag=orange] as @a[distance=..3,team=!orange,tag=!died,tag=!admin,scores={respawnshield=..0}] run tag @s add hit")
s("")
s("# Magenta killscreen")
s("execute if entity @s[tag=magenta] as @a[distance=..3,team=!magenta,tag=!died,tag=!admin,scores={respawnshield=..0}] run title @s subtitle {\"text\":\"\\uE004\"}")
s("execute if entity @s[tag=magenta] as @a[distance=..3,team=!magenta,tag=!died,tag=!admin,scores={respawnshield=..0}] run title @s title [\"\",{\"text\":\" \\uE010 \"},{\"text\":\"Sploded! \",\"bold\":true,\"color\":\"light_purple\"},{\"text\":\"\\uE010\"}]")
s("execute if entity @s[tag=magenta] as @a[distance=..3,team=!magenta,tag=!died,tag=!admin,scores={respawnshield=..0}] run tag @s add hit")
s("")
s("# Hit supply crates")
