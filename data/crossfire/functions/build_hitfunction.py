...
for i in range(1, 12):
    name = "player" + str(i)
    s("execute if score result result matches 1 if entity @s[tag="+name+"] run tellraw @a [\"\",{\"selector\":\"@a[tag="+name+",limit=1]\"},{\"text\":\" has hit a crate! It's about to fall down!\",\"color\":\"white\"}]")
s("")
s("# Remove hit tags")
