...
for i in range(1, 12):
    ...
    s("execute if entity @s[tag="+name+",scores={map=0}] as @e[tag=hit] run tellraw @a[scores={map=0}] [\"\",{\"selector\":\"@s\"},{\"text\":\" was sploded by \"},{\"selector\":\"@a[tag="+name+",limit=1]\"}]")
    s("execute if entity @s[tag="+name+",scores={map=1}] as @e[tag=hit] run tellraw @a[scores={map=1}] [\"\",{\"selector\":\"@s\"},{\"text\":\" was sploded by \"},{\"selector\":\"@a[tag="+name+",limit=1]\"}]")
