...
execute if score joined0 joined matches 2.. unless entity @a[tag=player1] if score playerscore0 player matches 0 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player1
...
execute if score joined0 joined matches 2.. as @a[tag=player1,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player2] if score playerscore0 player matches 1 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player2
...
execute if score joined0 joined matches 2.. as @a[tag=player2,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player3] if score playerscore0 player matches 2 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player3
...
execute if score joined0 joined matches 2.. as @a[tag=player3,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player4] if score playerscore0 player matches 3 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player4
...
execute if score joined0 joined matches 2.. as @a[tag=player4,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player5] if score playerscore0 player matches 4 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player5
...
execute if score joined0 joined matches 2.. as @a[tag=player5,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player6] if score playerscore0 player matches 5 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player6
...
execute if score joined0 joined matches 2.. as @a[tag=player6,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player7] if score playerscore0 player matches 6 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player7
...
execute if score joined0 joined matches 2.. as @a[tag=player7,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player8] if score playerscore0 player matches 7 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player8
...
execute if score joined0 joined matches 2.. as @a[tag=player8,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player9] if score playerscore0 player matches 8 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player9
...
execute if score joined0 joined matches 2.. as @a[tag=player9,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player10] if score playerscore0 player matches 9 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player10
...
execute if score joined0 joined matches 2.. as @a[tag=player10,scores={map=0}] run scoreboard players add playerscore0 player 1

execute if score joined0 joined matches 2.. unless entity @a[tag=player11] if score playerscore0 player matches 10 as @a[tag=!selected0,tag=joined,scores={map=0},limit=1] run tag @s add player11
...
execute if score joined0 joined matches 2.. as @a[tag=player11,scores={map=0}] run scoreboard players add playerscore0 player 1
