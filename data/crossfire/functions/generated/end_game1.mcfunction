...
tellraw @a[scores={map=1}] [""]
tellraw @a[scores={map=1}] ["",{"text":"Orange Team","color":"gold"},{"text":": "},{"score":{"name":"Orange","objective":"kills"},"color":"white"},{"text":" points","color":"white"}]
tellraw @a[scores={map=1}] ["",{"text":"Magenta Team","color":"light_purple"},{"text":": "},{"score":{"name":"Magenta","objective":"kills"},"color":"white"},{"text":" points","color":"white"}]
tellraw @a[scores={map=1}] [""]
tellraw @a[scores={map=1}] [""]
