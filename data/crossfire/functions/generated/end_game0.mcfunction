...
tellraw @a[scores={map=0}] [""]
tellraw @a[scores={map=0}] ["",{"text":"Red Team","color":"red"},{"text":": "},{"score":{"name":"Red","objective":"kills"},"color":"white"},{"text":" points","color":"white"}]
tellraw @a[scores={map=0}] ["",{"text":"Yellow Team","color":"yellow"},{"text":": "},{"score":{"name":"Yellow","objective":"kills"},"color":"white"},{"text":" points","color":"white"}]
tellraw @a[scores={map=0}] ["",{"text":"Green Team","color":"green"},{"text":": "},{"score":{"name":"Green","objective":"kills"},"color":"white"},{"text":" points","color":"white"}]
tellraw @a[scores={map=0}] ["",{"text":"Blue Team","color":"aqua"},{"text":": "},{"score":{"name":"Blue","objective":"kills"},"color":"white"},{"text":" points","color":"white"}]
tellraw @a[scores={map=0}] [""]
tellraw @a[scores={map=0}] [""]
