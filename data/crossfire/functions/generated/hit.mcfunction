...
execute if score result result matches 1 if entity @s[tag=player1,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player1,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player1,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player1,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player2,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player2,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player2,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player2,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player3,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player3,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player3,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player3,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player4,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player4,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player4,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player4,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player5,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player5,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player5,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player5,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player6,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player6,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player6,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player6,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player7,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player7,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player7,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player7,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player8,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player8,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player8,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player8,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player9,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player9,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player9,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player9,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player10,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player10,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player10,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player10,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player11,scores={map=0}] run tellraw @a[scores={map=0}] ["",{"selector":"@a[tag=player11,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
execute if score result result matches 1 if entity @s[tag=player11,scores={map=1}] run tellraw @a[scores={map=1}] ["",{"selector":"@a[tag=player11,limit=1]"},{"text":" has hit a crate! It's about to fall down!","color":"white"}]
...
execute if entity @s[tag=orange,tag=player1] if entity @a[distance=..3,team=orange,limit=1,tag=!player1] run title @a[tag=player1] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player1] if entity @a[distance=..3,team=magenta,limit=1,tag=!player1] run title @a[tag=player1] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player2] if entity @a[distance=..3,team=orange,limit=1,tag=!player2] run title @a[tag=player2] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player2] if entity @a[distance=..3,team=magenta,limit=1,tag=!player2] run title @a[tag=player2] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player3] if entity @a[distance=..3,team=orange,limit=1,tag=!player3] run title @a[tag=player3] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player3] if entity @a[distance=..3,team=magenta,limit=1,tag=!player3] run title @a[tag=player3] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player4] if entity @a[distance=..3,team=orange,limit=1,tag=!player4] run title @a[tag=player4] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player4] if entity @a[distance=..3,team=magenta,limit=1,tag=!player4] run title @a[tag=player4] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player5] if entity @a[distance=..3,team=orange,limit=1,tag=!player5] run title @a[tag=player5] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player5] if entity @a[distance=..3,team=magenta,limit=1,tag=!player5] run title @a[tag=player5] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player6] if entity @a[distance=..3,team=orange,limit=1,tag=!player6] run title @a[tag=player6] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player6] if entity @a[distance=..3,team=magenta,limit=1,tag=!player6] run title @a[tag=player6] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player7] if entity @a[distance=..3,team=orange,limit=1,tag=!player7] run title @a[tag=player7] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player7] if entity @a[distance=..3,team=magenta,limit=1,tag=!player7] run title @a[tag=player7] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player8] if entity @a[distance=..3,team=orange,limit=1,tag=!player8] run title @a[tag=player8] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player8] if entity @a[distance=..3,team=magenta,limit=1,tag=!player8] run title @a[tag=player8] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player9] if entity @a[distance=..3,team=orange,limit=1,tag=!player9] run title @a[tag=player9] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player9] if entity @a[distance=..3,team=magenta,limit=1,tag=!player9] run title @a[tag=player9] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player10] if entity @a[distance=..3,team=orange,limit=1,tag=!player10] run title @a[tag=player10] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player10] if entity @a[distance=..3,team=magenta,limit=1,tag=!player10] run title @a[tag=player10] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player11] if entity @a[distance=..3,team=orange,limit=1,tag=!player11] run title @a[tag=player11] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=magenta,tag=player11] if entity @a[distance=..3,team=magenta,limit=1,tag=!player11] run title @a[tag=player11] actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
...
execute if entity @s[tag=orange,tag=player1] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player1] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player1] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player1] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player2] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player2] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player2] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player2] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player3] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player3] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player3] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player3] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player4] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player4] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player4] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player4] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player5] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player5] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player5] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player5] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player6] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player6] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player6] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player6] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player7] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player7] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player7] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player7] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player8] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player8] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player8] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player8] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player9] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player9] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player9] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player9] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player10] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player10] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player10] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player10] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=orange,tag=player11] if entity @a[distance=..3,team=!orange,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player11] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=magenta,tag=player11] if entity @a[distance=..3,team=!magenta,tag=!died,scores={respawnshield=1..},limit=1] run title @a[tag=player11] actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
...
execute if entity @s[tag=player1,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player1,limit=1]"}]
execute if entity @s[tag=player1,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player1,limit=1]"}]
...
execute if entity @s[tag=player1,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player1,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player1,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player2,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player2,limit=1]"}]
execute if entity @s[tag=player2,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player2,limit=1]"}]
...
execute if entity @s[tag=player2,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player2,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player2,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player3,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player3,limit=1]"}]
execute if entity @s[tag=player3,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player3,limit=1]"}]
...
execute if entity @s[tag=player3,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player3,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player3,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player4,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player4,limit=1]"}]
execute if entity @s[tag=player4,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player4,limit=1]"}]
...
execute if entity @s[tag=player4,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player4,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player4,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player5,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player5,limit=1]"}]
execute if entity @s[tag=player5,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player5,limit=1]"}]
...
execute if entity @s[tag=player5,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player5,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player5,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player6,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player6,limit=1]"}]
execute if entity @s[tag=player6,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player6,limit=1]"}]
...
execute if entity @s[tag=player6,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player6,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player6,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player7,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player7,limit=1]"}]
execute if entity @s[tag=player7,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player7,limit=1]"}]
...
execute if entity @s[tag=player7,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player7,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player7,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player8,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player8,limit=1]"}]
execute if entity @s[tag=player8,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player8,limit=1]"}]
...
execute if entity @s[tag=player8,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player8,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player8,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player9,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player9,limit=1]"}]
execute if entity @s[tag=player9,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player9,limit=1]"}]
...
execute if entity @s[tag=player9,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player9,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player9,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player10,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player10,limit=1]"}]
execute if entity @s[tag=player10,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player10,limit=1]"}]
...
execute if entity @s[tag=player10,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player10,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player10,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
...
execute if entity @s[tag=player11,tag=selected0] as @e[tag=hit] run tellraw @a[scores={map=0}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player11,limit=1]"}]
execute if entity @s[tag=player11,tag=selected1] as @e[tag=hit] run tellraw @a[scores={map=1}] ["",{"selector":"@s"},{"text":" was sploded by "},{"selector":"@a[tag=player11,limit=1]"}]
...
execute if entity @s[tag=player11,tag=blue] as @e[tag=hit] run scoreboard players add Blue kills 1
execute if entity @s[tag=player11,tag=magenta] as @e[tag=hit] run scoreboard players add Magenta kills 1
execute if entity @s[tag=player11,tag=orange] as @e[tag=hit] run scoreboard players add Orange kills 1
