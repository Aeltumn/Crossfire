...
# Summon items
execute if score iron result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop0","drop","0"],ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{CustomPotionEffects:[{Id:1,Amplifier:1,Duration:400}],CustomPotionColor:10806260}}],Invisible:1}
...
execute if score iron result matches 2 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop2","drop","0"],ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{CustomPotionEffects:[{Id:28,Duration:400}],CustomPotionColor:16777215}}],Invisible:1}