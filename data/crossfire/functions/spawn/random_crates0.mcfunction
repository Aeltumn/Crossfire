...
# Gold crate
execute if score location0 result matches 0 if predicate crossfire:gold_chance positioned 539 78 411 run function crossfire:spawn/gold_crate0
execute if score location0 result matches 1 if predicate crossfire:gold_chance positioned 536 74 428 run function crossfire:spawn/gold_crate0
execute if score location0 result matches 2 if predicate crossfire:gold_chance positioned 518 78 431 run function crossfire:spawn/gold_crate0
execute if score location0 result matches 3 if predicate crossfire:gold_chance positioned 522 74 415 run function crossfire:spawn/gold_crate0
execute if score location0 result matches 4 if predicate crossfire:gold_chance positioned 536 74 428 run function crossfire:spawn/gold_crate0
execute if score location0 result matches 5 if predicate crossfire:gold_chance positioned 522 74 415 run function crossfire:spawn/gold_crate0