...
tellraw @a[scores={map=1}] ["",{"text":"An "},{"text":"iron crate","color":"gray"},{"text":" has appeared above the arena!"}]
execute as @a[scores={map=1}] at @s run playsound minecraft:block.note_block.bit master @s ~ ~ ~ 20 1