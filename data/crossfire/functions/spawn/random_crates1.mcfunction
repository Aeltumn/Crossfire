...
# Iron crate
execute if score location1 result matches 0 if predicate crossfire:iron_chance positioned 513 75 296 run function crossfire:spawn/iron_crate
execute if score location1 result matches 1 if predicate crossfire:iron_chance positioned 545 75 296 run function crossfire:spawn/iron_crate
