...
execute as @a if score @s intro matches 22 run tellraw @s ["",{"text":"The team that gets the most points will win in the end."},{"text":" You get one point for every kill,","color":"red"},{"text":" but lose a point every time you fall into the water.","color":"aqua"}]
execute as @a if score @s intro matches 22 run tellraw @s [{"text":""}]

# Reset intro to -1 at the end by resetting the player
execute as @a if score @s intro matches 22 run scoreboard players set @s introCompleted 1
execute as @a if score @s intro matches 22 run scoreboard players set @s map 0
execute as @a if score @s intro matches 22 run function crossfire:reset_player
