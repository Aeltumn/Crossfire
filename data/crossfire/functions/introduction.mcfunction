...
execute as @a if score @s intro matches 65 run tellraw @s [{"text":""}]
execute as @a if score @s intro matches 75 run tellraw @s ["",{"text":"The team that gets the most points will win in the end."},{"text":" You get one point for every kill,","color":"red"},{"text":" but lose a point every time you fall into the water.","color":"aqua"}]
execute as @a if score @s intro matches 75 run tellraw @s [{"text":""}]

# Reset intro to -1 at the end by restting the player
execute as @a if score @s intro matches 85 run scoreboard players set @s map 0
execute as @a if score @s intro matches 85 run function crossfire:reset_player
