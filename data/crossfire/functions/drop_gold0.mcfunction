...
# Summon items
execute if score gold result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop3","drop","0"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",CustomModelData:0,Count:1b}],Invisible:1}
execute if score gold result matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop4","drop","0"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",CustomModelData:1,Count:1b}],Invisible:1}