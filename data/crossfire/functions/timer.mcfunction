...
execute if score starttimer starttimer matches 0 run bossbar set crossfire:timer players @a
execute if score starttimer starttimer matches 0 run scoreboard players set gametimer gametimer 300
execute if score starttimer starttimer matches 0 run execute store result bossbar crossfire:timer max run scoreboard players get gametimer gametimer
