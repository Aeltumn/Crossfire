...
# Summon items
execute if score gold result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop3","drop"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",CustomModelData:0,Count:1b,tag:{display:{Name:"Rapid Fire Powerup"}}}],Invisible:1}
execute if score gold result matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop4","drop"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",CustomModelData:1,Count:1b,tag:{display:{Name:"Multishot Powerup"}}}],Invisible:1}