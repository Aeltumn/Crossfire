...
# Summon items
execute if score gold result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop3","drop"],ArmorItems:[{},{},{},{id:"minecraft:orange_dye",Count:1b,tag:{display:{Name:"Rapid Fire Powerup"}}}],Invisible:1}
execute if score gold result matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop4","drop"],ArmorItems:[{},{},{},{id:"minecraft:magenta_dye",Count:1b,tag:{display:{Name:"Multishot Powerup"}}}],Invisible:1}