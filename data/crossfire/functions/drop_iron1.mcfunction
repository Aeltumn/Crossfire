...
# Summon items
execute if score iron result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop0","drop","1"],ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{CustomPotionEffects:[{Id:1,Amplifier:1,Duration:400}],CustomPotionColor:10806260,display:{Name:"Potion of Swiftness II"}}}],Invisible:1}
execute if score iron result matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop1","drop","1"],ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{CustomPotionEffects:[{Id:8,Amplifier:4,Duration:400}],CustomPotionColor:1309504,display:{Name:"Potion of Jump Boost V"}}}],Invisible:1}
execute if score iron result matches 2 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop2","drop","1"],ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{CustomPotionEffects:[{Id:28,Duration:400}],CustomPotionColor:16777215,display:{Name:"Potion of Slow Falling I"}}}],Invisible:1}