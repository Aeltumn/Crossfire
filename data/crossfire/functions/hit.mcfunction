...
execute if entity @s[tag=red] if entity @e[distance=..3,type=minecraft:player,team=!red,tag=!died,scores={respawnshield=1..},limit=1] run title @s actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=yellow] if entity @e[distance=..3,type=minecraft:player,team=!yellow,tag=!died,scores={respawnshield=1..},limit=1] run title @s actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=green] if entity @e[distance=..3,type=minecraft:player,team=!green,tag=!died,scores={respawnshield=1..},limit=1] run title @s actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]
execute if entity @s[tag=blue] if entity @e[distance=..3,type=minecraft:player,team=!blue,tag=!died,scores={respawnshield=1..},limit=1] run title @s actionbar ["",{"text":"You've hit a player that was still respawning!","color":"yellow"}]

# Send message if you hit a teammate
execute if entity @s[tag=red] if entity @e[distance=..3,type=minecraft:player,team=red,limit=1] run title @s actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=yellow] if entity @e[distance=..3,type=minecraft:player,team=yellow,limit=1] run title @s actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=green] if entity @e[distance=..3,type=minecraft:player,team=green,limit=1] run title @s actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]
execute if entity @s[tag=blue] if entity @e[distance=..3,type=minecraft:player,team=blue,limit=1] run title @s actionbar ["",{"text":"Don't attack your teammates!","color":"red"}]

execute if entity @s[tag=blue] if entity @e[distance=..3,type=minecraft:player,team=blue,limit=1] run say @s
