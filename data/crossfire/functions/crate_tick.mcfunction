...
execute as @e[tag=dropped] at @s unless block ~ ~-1 ~ minecraft:air run function crossfire:drop_iron
execute as @e[tag=dropped,scores={age=40..}] at @s run function crossfire:drop_iron
