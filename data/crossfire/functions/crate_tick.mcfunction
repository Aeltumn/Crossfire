...
execute as @e[tag=dropped,scores={age=40..}] if data entity @s {OnGround:1b} at @s run function crossfire:drop_iron
execute as @e[tag=dropped] unless block ~ ~-1 ~ minecraft:air at @s run function crossfire:drop_iron
