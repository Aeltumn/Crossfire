...
execute as @a[tag=died] if entity @s[team=red] if score @s deadtimer matches ..6 run title @a times 0 24 0
execute as @a[tag=died] if entity @s[team=red] if score @s deadtimer matches ..6 run title @s title {"text":" "}
execute as @a[tag=died] if entity @s[team=red] if score @s deadtimer matches ..6 run title @s subtitle ["",{"text":"Respawning in: "},{"score":{"name":"@s","objective":"deadtimer"},"bold":true,"color":"gold"}]
