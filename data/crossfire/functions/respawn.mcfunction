...
execute as @a[tag=died] if score @s deadtimer matches 3 at @s run playsound minecraft:item.trident.return master @a ~ ~ ~ 100 0
execute as @a[tag=died] if score @s deadtimer matches 3.. run spectate @e[limit=1,tag=spectate] @s
