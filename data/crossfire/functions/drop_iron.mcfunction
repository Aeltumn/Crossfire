...
# Summon items
summon minecraft:item ~ ~ ~ {ActiveEffects:[{Id:24,Amplifier:0,Duration:999999}],PickupDelay:0,Age:-32768,Tags:["cleanup"],Item:[id:"minecraft:potion",tag:{CustomPotionEffects:[{Id:1,Amplifier:2,Duration:20}]}]}