...
# Summon items
execute if score gold result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop3","drop","1"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",CustomModelData:0,Count:1b,tag:{display:{Name:"Rapid Fire Power-up"}}}],Invisible:1}
execute if score gold result matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop4","drop","1"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",CustomModelData:1,Count:1b,tag:{display:{Name:"Multishot Power-up"}}}],Invisible:1}