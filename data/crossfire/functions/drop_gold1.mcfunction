...
execute if score gold result matches 0 run tellraw @a[scores={map=1}] ["",{"text":"The ","color":"white"},{"text":"Rapid Fire Powerup","color":"gold","hoverEvent":{"action":"show_text","value":["",{"text":"Increases the user's fire rate tremendously.","color":"white"}]}},{"text":" power-up has been dropped by a shiny crate!","color":"white"}]
