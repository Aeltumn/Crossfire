...
execute if score map map matches 1 run fill 509 70 401 549 70 441 air replace barrier
execute if score map map matches 1 run fill 509 70 276 549 70 316 air replace barrier
