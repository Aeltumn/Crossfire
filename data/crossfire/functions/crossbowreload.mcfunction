...
execute as @a unless entity @s[tag=reloadcrossbow,scores={isreloading=1..,respawnshield=..3},tag=!died,tag=!admin,nbt={SelectedItem:{id:"minecraft:crossbow",tag:{Charged:0b}}}] run scoreboard players set @s timer 1
execute as @a unless entity @s[tag=reloadcrossbow,scores={isreloading=1..,respawnshield=..3},tag=!died,tag=!admin,nbt={SelectedItem:{id:"minecraft:crossbow",tag:{Charged:0b}}}] run scoreboard players set @s isreloading 0
