...
execute as @a[tag=!died,tag=!admin,tag=givecrossbow] store result score @s item run clear @s minecraft:crossbow 0
execute as @a[tag=!died,tag=!admin,tag=givecrossbow] if score @s item matches 0 run give @s minecraft:crossbow

# Determine whether or not the player is currently allowed to reload
execute as @a[tag=crossbowreload,scores={respawnshield=..3},tag=!died,tag=!admin,nbt={Inventory:[{id:"minecraft:crossbow",tag:{Charged:0b}}]}] as @s run scoreboard players set @s isreloading 1
...
execute as @a[scores={timer=31..40}] run replaceitem entity @s container.0 crossbow{CustomModelData:17,HideFlags:63} 1
execute as @a[scores={timer=31..40}] run replaceitem entity @s container.0 crossbow{CustomModelData:18,HideFlags:63} 1
execute as @a[scores={timer=31..40}] run replaceitem entity @s container.0 crossbow{CustomModelData:19,HideFlags:63} 1
execute as @a[scores={timer=31..40}] run replaceitem entity @s container.0 crossbow{CustomModelData:20,HideFlags:63} 1
