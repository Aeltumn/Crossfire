execute as @a at @s if block ~ ~-1 ~ minecraft:lime_concrete if entity @s[team=!green,tag=!admin] run title @a times 10 40 10
execute as @a at @s if block ~ ~-1 ~ minecraft:lime_concrete if entity @s[team=!green,tag=!admin] run title @a subtitle ["",{"text":"Joined team "},{"text":"green","bold":true,"color":"green"}]
execute as @a at @s if block ~ ~-1 ~ minecraft:lime_concrete if entity @s[team=!green,tag=!admin] run title @a title {"text":"\uE000"}
...
execute as @a at @s if block ~ ~-1 ~ minecraft:red_concrete if entity @s[team=!red,tag=!admin] run title @a times 10 40 10
execute as @a at @s if block ~ ~-1 ~ minecraft:red_concrete if entity @s[team=!red,tag=!admin] run title @a subtitle ["",{"text":"Joined team "},{"text":"red","bold":true,"color":"red"}]
...
execute as @a at @s if block ~ ~-1 ~ minecraft:yellow_concrete if entity @s[team=!yellow,tag=!admin] run title @a times 10 40 10
execute as @a at @s if block ~ ~-1 ~ minecraft:yellow_concrete if entity @s[team=!yellow,tag=!admin] run title @a subtitle ["",{"text":"Joined team "},{"text":"yellow","bold":true,"color":"yellow"}]
...
execute as @a at @s if block ~ ~-1 ~ minecraft:light_blue_concrete if entity @s[team=!blue,tag=!admin] run title @a times 10 40 10
execute as @a at @s if block ~ ~-1 ~ minecraft:light_blue_concrete if entity @s[team=!blue,tag=!admin] run title @a subtitle ["",{"text":"Joined team "},{"text":"blue","bold":true,"color":"aqua"}]
