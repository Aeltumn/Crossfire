...
execute as @a at @s if block ~ ~-1 ~ minecraft:lime_concrete if entity @s[team=!green,tag=!admin] run tellraw @s ["",{"text":"You joined team: "},{"text":"Green","color":"green"}]
...
execute as @a at @s if block ~ ~-1 ~ minecraft:red_concrete if entity @s[team=!red,tag=!admin] run tellraw @s ["",{"text":"You joined team: "},{"text":"Red","color":"red"}]
...
execute as @a at @s if block ~ ~-1 ~ minecraft:yellow_concrete if entity @s[team=!yellow,tag=!admin] run tellraw @s ["",{"text":"You joined team: "},{"text":"Yellow","color":"yellow"}]
...
execute as @a at @s if block ~ ~-1 ~ minecraft:light_blue_concrete if entity @s[team=!blue,tag=!admin] run tellraw @s ["",{"text":"You joined team: "},{"text":"Blue","color":"aqua"}]
